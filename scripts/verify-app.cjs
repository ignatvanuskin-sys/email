...
(async () => {
  ...
  const verifyEnv = {
    ...
    WEBHOOK_SECRET: process.env.WEBHOOK_SECRET || 'verify-generic-webhook-secret-change-me-32-characters',
    ...
    CRON_SECRET: process.env.CRON_SECRET || 'verify-cron-secret-change-me-32-characters',
    TELEGRAM_WEBHOOK_SECRET: process.env.TELEGRAM_WEBHOOK_SECRET || 'verify-telegram-secret-change-me-32-characters',
    STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET || 'verify-stripe-secret-change-me-32-characters',
