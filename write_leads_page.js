    ...
    <div>
      <div className="page-head">
        <div>
          ...
          <p className="page-sub">{lead.companyOrChannel || lead.niche || ""}</p>
        </div>
        <Link href="/leads" className="btn">Back</Link>
      </div>

      {note && <div className="card" style={{ padding: 12, marginBottom: 16, borderColor: "var(--red)", color: "var(--red)" }}>{note}</div>}
